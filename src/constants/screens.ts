...
const screens = {
  //SCREENS
    ...
    FORGOTTON_PASSWORD_SCREEN: { name: 'fogotten-password.screen', key: 'fogotten-password.screen'},
    ...
    NOTIFICATION_SCREEN: { name: 'notification.screen', key: 'notification.screen'},

  //NAVIGATORS
  GENERAL_USER_NAVIGATOR: { name: 'general-user.navigator', key: 'general-user.navigator' },
  SHELTER_USER_NAVIGATOR: { name: 'shelter-user.navigator', key: 'shelter-user.navigator' },
